				...
				<TBODY>
					...
					<tr>
						<td class="ta_01" align="right">
							<button type="button" id="add" name="add" value="添加" class="button_add" onclick="addCategroySecond()">
&#28155;&#21152;
</button>
					...
					<tr align="center">
						<td class="ta_01" align="center" bgColor="#afd1f3">
							...
							<a href="${pageContext.request.contextPath}/adminCategorySecond_findAll.action?page=1<s:property value="pageBean.totalPage"/>">尾页</a>
							</s:if>
						</td>
					</tr>
				</TBODY>
